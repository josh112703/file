<!-- Page Loader -->
<div id="pageLoader" class="page-loader-wrapper">
  <div class="loader">
    <div class="preloader">
...
// You should replace this with your actual use case
setTimeout(hideLoader, 1000); // Hides the loader after 3 seconds
</script>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <ul class="list">
                    ...
                    <li>
                        <a href="index.php" >
                            ...
                            <span>Kape Zebra Inventory</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2023 - 2024 <a href="index.php">Kape Zebra</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>

...
if (count($_POST) > 0) {
    ...
    mysqli_query($conn,"UPDATE `ingredient_inventory` SET 
        Item_name='" . $Item_name . "', 
        Item_qty='" . $Item_qty . "', 
...
$result = mysqli_query($conn, "SELECT * FROM `ingredient_inventory` WHERE Item_ID='" . $_GET['id'] . "'");
                        ...
                        <div class="body">
                            <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="Item_name" class="form-control" maxlength="12" value="<?php echo $row["Item_name"]; ?>" name="Item_name">
                                    </div>
                                </div>
                                <label for="Item_name">Item_qty</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="Item_qty" class="form-control" maxlength="100" value="<?php echo $row["Item_qty"]; ?>" name="Item_qty">
                                    </div>
                                </div>
                                <label for="Item_price">Item Price</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="Item_price" class="form-control" maxlength="100" value="<?php echo $row["Item_price"]; ?>" name="Item_price">
                                    </div>
                                </div>
